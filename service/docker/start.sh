...
exec java ${MANDATORY_JAVA_OPTS} ${JAVA_OPTS} -Dorg.eclipse.jetty.server.Request.maxFormContentSize=5000000 -jar /usr/src/aurea-zero-based/service/aurea-zero-based-api/build/libs/aurea-zero-based-api.jar
