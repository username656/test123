...
describe('CreatePasswordPageComponent', () => {
  ...
  it('should create the form on ngOnInit with a valid token', () => {
    spyOn(authenticationService, 'checkForValidToken').and.returnValue(of({status: 200}));
    component.ngOnInit();
    expect(component.form).toBeDefined();
  });

  it('should redirect to error page on ngOnInit', () => {
    spyOn(authenticationService, 'checkForValidToken').and.returnValue(_throw({status: 404}));
